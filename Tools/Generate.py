...
Experiments = ["AUG09", "AUG11", "GAM", "HIRES1MONO", "HIRES2MONO", "HIRSTEREO", "HIRESMIA", "ICE", "KASQGS", "KASSIBYLL",
 "TA", "TIBETIII1", "TIBETIII2", "TIBETIII3", "TUNKA", "CAS","KAS05", "GRANQGS2", "AGA03", "AMS", "ATIC", "PAMELA", "PAMELA_CATO", "CREAM", "BESS", "TUNKA_Prelim"]
LegendNames = ["Auger (2009)", "Auger (2011)", "GAMMA", "HiRes-I Mono", "HiRes-II Mono", "HiRes-II Stereo", "HiRes/MIA", "IceTop", "Kascade (QGSJet)", "Kascade (Sibyll)",
 ...
 "AGASA (2003)", "AMS (2000)", "ATIC (2009)", "PAMELA (2011)", "PAMELA Cato (2013)", "CREAM (2011)", "BESS (2015)", "TUNKA_Prelim (2010)"]
...
"CRDB_PAMELA", "CRDB_PAMELA_CATO,", "CRDB_CREAM", "CRDB_BESS", "CRDB_TUNKA_Prelim"]
